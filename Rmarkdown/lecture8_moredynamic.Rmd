...
head(result$conc)
filled.contour(result$conc, xlab="Time", ylab="Distance") #time on x, distance on y, color = concentration
...
res <- diff1(initialC = 20, nx = 10, dx = 1, nt = 10, dt = 30, D = 0.006, area = 2)
