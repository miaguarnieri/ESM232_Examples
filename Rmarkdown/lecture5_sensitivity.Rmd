...
colnames(parm_quant)=pnames #make the column names the same as parameter names
...
parm[,"Tmincoeff1"] = qnorm(parm_quant[,"Tmincoeff1"], mean=-0.015, sd=0.015/pvar) #can designate a sd if you know what it will be
